...
style button:
    ...
    hover_sound "audio/menu/menu_cursor.wav"
    activate_sound "audio/menu/menu_decision.wav"
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Quit to Desktop") action Quit(confirm=not main_menu)
            ...
            textbutton _("Characters") action ShowMenu("chara_info")
            textbutton _("About") action ShowMenu("about")
...
style page_button:
    ...
    activate_sound "audio/menu/page.wav"
        ...
        vbox:
            ...
            hbox:
                ...
                if GamepadExists():
                    ...
                    textbutton _("{color=#ff0000}Gamepad{/color}"):
                        action NullAction()
                        activate_sound "audio/menu/menu_buzzer.wav"
